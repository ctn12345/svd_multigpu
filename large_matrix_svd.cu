...
void svd_large_matrix_1(int gpu,cudaStream_t& stream,bool isfinal,double* dev_A, int* shape, double* dev_diag, double* dev_U, double* dev_V,double* dev_V0, int th, int tw,
